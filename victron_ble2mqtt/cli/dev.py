...
def install():
    """
    Run pip-sync and install 'victron_ble2mqtt' via pip as editable.
    """
...
def publish():
    ...
    publish_package(
        module=victron_ble2mqtt,
        package_path=PACKAGE_ROOT,
        distribution_name='victron_ble2mqtt',
    )
