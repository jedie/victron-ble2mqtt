...
from victron_ble2mqtt.cli_dev import PACKAGE_ROOT, app
...
def install():
    """
    Install requirements and 'victron_ble2mqtt' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=victron_ble2mqtt, package_path=PACKAGE_ROOT)
